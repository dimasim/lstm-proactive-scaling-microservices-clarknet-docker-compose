...
// Read the extracted peak window dataset
const trafficData = new SharedArray('peak traffic', function () {
    return JSON.parse(open('./k6_s2_peak_data.json'));
});
...
export const options = {
    ...
    // We want to observe the whole 20 min window.
    thresholds: {
